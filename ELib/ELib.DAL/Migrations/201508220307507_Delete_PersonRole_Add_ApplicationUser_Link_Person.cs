namespace ELib.DAL.Migrations
{
    ...
    public partial class Delete_PersonRole_Add_ApplicationUser_Link_Person : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            AddColumn("dbo.Person", "RoleId", c => c.Int(nullable: false));
            AddColumn("dbo.Person", "Password", c => c.String(nullable: false, maxLength: 50, unicode: false));
            ...
            AddForeignKey("dbo.Person", "RoleId", "dbo.PersonRole", "Id");
        }
    }
}
